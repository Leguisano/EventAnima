...
<script>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="https://certificadosanimatic.com.br/e-cont/" class="nav-item nav-link">Certificados</a>
    ...
    <div id="divRA" class="form-floating" style='display:none;'>
        ...
        <div id="divTel" class="form-floating" style='display:none;'>
            ...
            <input type="number" class="form-control" id="floatingFone" placeholder="(XX) XXXXX-XXXX" name="fone" >
